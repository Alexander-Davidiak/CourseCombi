...
(function (w) {
  ...
  function Vf() {
    ...
    var e = G(a) && d in a;!0 === b ? b = pa : E(b) || (b = function b(a, _b2) {
      if (x(a)) return !1;if (null === a || null === _b2) return a === _b2;if (G(_b2) || G(a) && !Xb(a)) return !1;a = P("" + a);_b2 = P("" + _b2);return -1 !== a.indexOf(_b2);
    });return function (f) {
...
var CourseCombiApp = angular.module('CourseCombiApp', []);
...
function addTimeValue(e) {
  ...
  var index = document.getElementById(e.target.id).innerHTML.indexOf('<input type="button"');
  document.getElementById(e.target.id).innerHTML = document.getElementById(e.target.id).innerHTML.substring(0, index);
  document.getElementById(e.target.id).innerHTML += "<input type='number' name=''" + " value='' id='numb' max='23' min='0'>:<input type='number' name='' value='' id='numb' max='23' min='0'><br>" + " <input type='button' id='" + e.target.id + "' onclick='addTimeValue(event)' value='+'><br>";
}